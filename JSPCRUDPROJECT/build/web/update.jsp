...
<center>
    ...
    <table cellpadding='12'>
        <tr>
            <td>NAME</td>
            <td><input type='text' value='<%=rs.getString(1)%>' name='n11'></td>
        </tr>
        <tr>
            <td>ROLLNO</td>
            <td><input type='text' value='<%=rs.getString(2)%>' name='n12'></td>
        </tr>
        <tr>
            <td>PHYSICS</td>
            <td><input type='text' value='<%=rs.getString(3)%>' name='n13'></td>
        </tr>
        <tr>
            <td>CHEMISTRY</td>
            <td><input type='text' value='<%=rs.getString(4)%>' name='n14'></td>
        </tr>
        <tr>
            <td>MATHS</td>
            <td><input type='text' value='<%=rs.getString(5)%>' name='n15'></td>
        </tr>
        <tr>
            <th colspan="2"><input type="submit" value="UPDATE" class='button1'></th>
        </tr>
    </table>
    </form>
</center>
